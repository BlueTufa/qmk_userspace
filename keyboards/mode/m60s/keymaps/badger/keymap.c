...
[_FUNCTION]   = LAYOUT_ansi_bs(\
     ...
     _______,   _______,  _______,  KC_CAPS,  _______,  _______,  KC_MNXT,  KC_MUTE,  KC_WBAK,  _______,  _______,  _______,  CONFIG,   \
                _______,  _______,                                _______,                                _______,  _______   ),

[_MACRO]     = LAYOUT_ansi_bs(\
