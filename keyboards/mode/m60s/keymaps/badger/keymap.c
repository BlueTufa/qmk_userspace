...
[_QWERTY]     = LAYOUT_all(\
     ...
     MOVE_MAC,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,  _______,  KC_ENT,   \
     KC_LSFT,   _______,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,  J_MACRO,  \
...
[_MOVE]       = LAYOUT_all(\
     ...
     _______,   _______,  MM_UH,    MM_BH,    MAC_CPY,  MAC_SPS,  SHEBANG,  IJ_BOTT,  IJ_REN,   IJ_IMPL,  IJ_DECL,  IJ_USAG,  _______,  _______,  \
...
[_FUNCTION]   = LAYOUT_all(\
     ...
     _______,   _______,  _______,  _______,  KC_CAPS,  _______,  _______,  KC_MNXT,  KC_MUTE,  KC_WBAK,  KC_WFWD,  KC_WSCH,  _______,  CONFIG,   \
                _______,  _______,                                _______,                                _______,  _______   ),
...
[_MACRO]     = LAYOUT_all(\
     ...
     _______,   _______,  _______,  _______,  CONST,    _______,  SHEBANG,  TS_IMPT,  _______,  _______,  _______,  _______,  _______,  _______,  \
                _______,  _______,                                _______,                                _______,  _______   ),
...
[_CONFIG]     = LAYOUT_all(\
     ...
     _______,   _______,  _______,  _______,  _______,  RGB_RMOD, RGB_HUD,  RGB_SAD,  RGB_SPD,  RGB_M_K,  _______,  _______,  _______,  _______,  \
                _______,  _______,                                _______,                                _______,  _______   )
};
